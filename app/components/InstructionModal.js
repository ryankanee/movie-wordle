      ...
      <div className="instruction-modal">
        ...
        <div className="instruction-modal-content">
          <div className="instructions-text">
            <p>
              🎬 <strong>Guess the movie title in 10 tries or fewer!</strong>
            </p>
            <p>
              📝 Start typing to see movie suggestions, then click to make your
              guess
            </p>
            <p>
              🎨 Each guess will show you movie information with color-coded
              hints
            </p>
          </div>
          ...
          <div className="legend">
            ...
            <div className="legend-item">
              ...
              <span>
                <strong>Yellow</strong> - Close match (Year: ±5, Gross: ±$50M,
                Oscars: ±1)
              </span>
            </div>
            <div className="legend-item">
